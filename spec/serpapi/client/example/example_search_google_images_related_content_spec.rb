...
describe 'example: google_images_related_content search' do
  it 'prints organic_results' do
    ...
    client = SerpApi::Client.new(engine: 'google_images_related_content', api_key: api_key)
    ...
    # doc: http://serpapi.com/google-images-related-content-api
  end
end
